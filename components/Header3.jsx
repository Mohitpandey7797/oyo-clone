        ...
        <div className="bg-gradient-to-r from-red-600 to-red-400 h-60" >
            <div className="p-5">
                ...
                <div className="grid grid-cols-5 my-5 mx-20 ">
                    <input type="text" placeholder="Search..." className="h-16 outline-none px-3 text-lg border-r-2 rounded-l-lg border-gray-400 col-span-2" onChange={(e)=>{setCity(e.target.value)}} />
                    ...
                    <button type="submit" className="h-16 px-3 py-2 col-span-1 bg-green-400 hover:cursor-pointer hover:bg-green-600 rounded-r-lg text-white text-xl"><Link href={`/hotels?city=${city}`}>Search</Link></button>
