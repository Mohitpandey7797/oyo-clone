                ...
                <div className="flex justify-center items-center w-9/12">
                    ...
                    <div className="ml-20  w-10/12 bg-white pb-10">
                        ...
                        <div className="px-10  ">
                            ...
                            <input type="email" placeholder="Enter your name.." className=" outline-none border  my-3 border-black-400 px-3 py-1 w-96 h-10" />

                            <input type="email" placeholder="Enter your email.." className=" outline-none border  my-3 border-black-400 px-3 py-1 w-96 h-10" />

                            <input type="email" placeholder="Enter your password.." className=" outline-none border  my-3 border-black-400 px-3 py-1 w-96 h-10" />
